...
<script type="text/javascript">
        $(function () {
            $('#tab').datagrid({
                ...
                columns:[[
                    {field:'pictureId',title:'图片编号',width:200,align:'center',sortable:true},
                    {field:'picturePath',title:'图片名',width:200,sortable:true,align:'center',sortable:true},
                    {field:'pictureDescription',title:'描述信息',width:130,align:'center',sortable:true},
                    {field:'pictureStatus',title:'轮播状态',width:30,align:'center'},
